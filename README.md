...
### INSTALL SCRIPT
<pre><code>apt update -y && apt install -y wget curl jq golang-go && wget -q https://raw.githubusercontent.com/GeKaStore/installer-os/main/Install.sh && chmod +x Install.sh && ./Install.sh</code></pre>
